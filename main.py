...
def parse_args():
    ...
    parser.add_argument('-s', '--source', default='.', help='Path where music subfolders are')
    parser.add_argument('-d', '--destination', default='.', help='Path where playlist files are placed')
